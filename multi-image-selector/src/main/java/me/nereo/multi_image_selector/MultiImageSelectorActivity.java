...
public class MultiImageSelectorActivity extends FragmentActivity implements MultiImageSelectorFragment.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsTakePhoto = intent.getBooleanExtra(EXTRA_TAKE_CAMERA, false);
        ...
        getSupportFragmentManager().beginTransaction()
                .add(R.id.image_grid_container, Fragment.instantiate(this, MultiImageSelectorFragment.class.getName(), bundle))
                .commit();
    ...
    public void onAttachedToWindow() {
        ...
        gridView.performItemClick(gridView.getAdapter().getView(0, null, gridView), 0, 0);
    }
}
