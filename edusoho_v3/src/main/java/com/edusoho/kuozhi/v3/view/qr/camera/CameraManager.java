...
package com.edusoho.kuozhi.v3.view.qr.camera;
...
import com.edusoho.kuozhi.v3.view.qr.camera.open.OpenCameraManager;
...
public final class CameraManager {
	...
	/**
	 * Calculates the framing rect which the UI should draw to show the data
	 * where to place the barcode. This target helps with alignment as well as
	 * forces the data to hold the device far enough away to ensure the image
	 * will be in focus.
	 * 
