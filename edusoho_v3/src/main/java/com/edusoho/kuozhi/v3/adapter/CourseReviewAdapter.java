...
public class CourseReviewAdapter extends BaseAdapter implements View.OnClickListener{
    ...
    public CourseReviewAdapter(Context mContext, int mId) {
        this.mId = mId;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CourseReview review = mList.get(position);
    ...
    public static class ViewHolder{
        ...
        public ViewHolder(View view) {
            mDesc = (TextView) view.findViewById(R.id.tv_review_desc);
            mName = (TextView) view.findViewById(R.id.tv_review_name);
            mTime = (TextView) view.findViewById(R.id.tv_review_time);
            mIcon = (ImageView) view.findViewById(R.id.iv_review_icon);
            mStar = (ReviewStarView) view.findViewById(R.id.v_review_star);
        }
    }
    ...
    private void jumpToMember(String id) {
        final String url = String.format(
                ...
                ((EdusohoApp) mContext.getApplicationContext()).schoolHost,
