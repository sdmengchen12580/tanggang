...
/**
 * Created by JesseHuang on 15/1/19.
 */
public class ESExpandableTextView extends LinearLayout implements View.OnClickListener {

    private static final String TAG = ESExpandableTextView.class.getSimpleName();
    ...
    public ESExpandableTextView(Context context) {
        super(context);
    }

    public ESExpandableTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public ESExpandableTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ESExpandableTextView);
