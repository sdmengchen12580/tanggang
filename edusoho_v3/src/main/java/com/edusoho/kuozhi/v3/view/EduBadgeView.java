...
/**
 * Created by JesseHuang on 15/6/5.
 */
...
public class EduBadgeView extends TextView {

    private boolean mHideOnNull = true;

    public EduBadgeView(Context context) {
        this(context, null);
    }

    public EduBadgeView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public EduBadgeView(Context context, AttributeSet attrs, int defStyle) {
