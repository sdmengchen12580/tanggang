...
package com.edusoho.kuozhi.v3.view.qr.common;
 ...
 * has checked the API level. This requires reflection, showLoading one of several implementations based on the
 * API level.</p>
 *
