...
public class AuthOkPop {
    ...
    public AuthOkPop(Context baseActivity) {
    ...
    public PopupWindow showPop(ClickCallback clickCallback) {
        ...
        if (baseActivity != null) {
            popView = LayoutInflater.from(baseActivity)
                    .inflate(R.layout.pop_layout_auth_ok, null, false);

            TextView tv_start_ks = popView.findViewById(R.id.tv_start_ks);
            tv_start_ks.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (AuthOkPop.this.clickCallback != null) {
                        dismissPop();
                        AuthOkPop.this.clickCallback.startks();
                    }
                }
            });
