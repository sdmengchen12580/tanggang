...
public class AuthTakePicPop {
    ...
    public AuthTakePicPop(Context baseActivity) {
    ...
    public PopupWindow showPop(ClickCallback clickCallback) {
        ...
        if (baseActivity != null) {
            popView = LayoutInflater.from(baseActivity)
                    .inflate(R.layout.pop_layout_auth_take_pic, null, false);

            TextView tv_take_pic = popView.findViewById(R.id.tv_take_pic);
            tv_take_pic.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (AuthTakePicPop.this.clickCallback != null) {
                        AuthTakePicPop.this.clickCallback.takePic();
                    }
                }
            });
