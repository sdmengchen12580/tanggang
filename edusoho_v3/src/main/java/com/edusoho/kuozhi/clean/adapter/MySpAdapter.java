...
import com.edusoho.kuozhi.clean.bean.CheckBean.SchedulesBean;
...
public class MySpAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MySpAdapter(Context context, int whichType, List<SchedulesBean> mList, ClickCallBack clickCallBack) {
        this.whichType = whichType;
        this.clickCallBack = clickCallBack;
        this.context = context;
        this.mList = mList;
        vpView1 = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DensityUtil.dip2px(context, 200f));
        vpView23 = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DensityUtil.dip2px(context, 145f));
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.itemlayout_sp_my, null);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof HasViewHolder) {
            ...
            ((HasViewHolder) holder).tv_people.setText("申请人：" + bean.getTruename());
            ((HasViewHolder) holder).tv_home_address.setText("教室位置:" + bean.getName());//教室位置不要
            ...
            if (bean.getStatus().equals("0")) {
                ...
                ((HasViewHolder) holder).tv_cancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (MySpAdapter.this.clickCallBack != null) {
                            MySpAdapter.this.clickCallBack.cancel(bean.getId());
                        }
                    }
                });
                ((HasViewHolder) holder).tv_aggree.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        if (FastClickUtils.isFastClick()) {
                            return;
                        ...
                        if (MySpAdapter.this.clickCallBack != null) {
                            MySpAdapter.this.clickCallBack.aggree(bean.getId());
                        }
                    }
                });
    ...
    private class HasViewHolder extends RecyclerView.ViewHolder {
        ...
        public HasViewHolder(View itemView) {
            ...
            tv_aggree = itemView.findViewById(R.id.tv_aggree);
    ...
    public interface ClickCallBack {
        ...
        void aggree(String id);
    }

    private ClickCallBack clickCallBack;

    public void setClickCallBack(ClickCallBack clickCallBac) {
