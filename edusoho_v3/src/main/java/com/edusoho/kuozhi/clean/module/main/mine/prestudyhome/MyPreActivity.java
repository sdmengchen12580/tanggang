...
import com.edusoho.kuozhi.clean.module.main.mine.prestudyhome.fragment.MyPreStateFragment;
...
public class MyPreActivity extends AppCompatActivity {

    private ImageView img_close;
    private XTabLayout tab_data;
    private ViewPager vp_my_pre;
//    private String titles[] = {"待审核", "已审核", "被驳回"};
    ...
    public static void launch(Context context) {
        Intent intent = new Intent(context, MyPreActivity.class);
        context.startActivity(intent);
    }

    private void initTab() {
        //"待审核", "已审核", "被驳回"
        fragments.add(MyPreStateFragment.newInstance(1));
//        fragments.add(MyPreStateFragment.newInstance(2));
//        fragments.add(MyPreStateFragment.newInstance(3));
...
//                ((TextView) tab.getCustomView().findViewById(R.id.tv_text)).setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
        ...
        tab_data.setOnTabSelectedListener(new XTabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(XTabLayout.Tab tab) {
                ((TextView) tab.getCustomView().findViewById(R.id.tv_text)).setTextColor(MyPreActivity.this.getResources().getColor(R.color.color_0292fd));
                ((TextView) tab.getCustomView().findViewById(R.id.tv_text)).setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
            ...
            public void onTabUnselected(XTabLayout.Tab tab) {
                ((TextView) tab.getCustomView().findViewById(R.id.tv_text)).setTextColor(MyPreActivity.this.getResources().getColor(R.color.color_161616));
